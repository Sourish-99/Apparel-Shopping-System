            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pad-botm">
                        <div class="col-md-12">
                            <h4 class="header-line" style="color: #FFF;">View Products</h4>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="uploads/<%=rs.getString(7)%>" alt="" class="pro-image-front" style="width: 100px; height: auto; display: block; margin-left: auto; margin-right: auto;"></td>
