...
public class DatabaseConnection {
    ...
    //Creating universal method to open connect will sql database
    public static Connection getConnection() {
        try {
            //Registering with sql Driver
            Class.forName("oracle.jdbc.driver.OracleDriver");
            connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/orcl", "scott", "sourish");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return (connection);
    ...
    //Creating universal method to close connect will sql database
